...
/**
 * The JFsmEngine has changed its state. If the event was external, the
 * eventType attribute will be set to EVENT_TYPE_EXTERNAL and the event received
 * can be obtained from the getEvent() method. If the event was internal, the
 * getEvent() method will return null and the the event_type will be set to the
 * proper type of internal event
 */
