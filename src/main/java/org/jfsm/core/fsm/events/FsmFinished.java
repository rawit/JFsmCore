...
/**
 * The JFsmEngine has reached a final (accepting) state and is terminating the
...
public class FsmFinished extends FsmEvent {
	 ...
	 * @param reason The reason for stopping execution. One of FSM_CANCELLED,
	 *        FSM_REACHED_FINAL_STATE or FSM_IN_ERROR
