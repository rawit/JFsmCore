...
/**
 * Utility class for JFsm. Contains methods to ease extraction of Java
 * class/object information using the reflection API
 */
public final class JFsmUtilities {
	...
	/**
	 * Strip method name and return only class name with full package prefix For
	 * example "java.lang.String.toString" will return "java.lang.String".
	 * 
	 ...
	 * @return the string found, or null if a format error was found in the
	 *         input string
	 */
	...
	/**
	 * Remove the package prefix from the string. I.e.
	 * "java.lang.String.toString" becomes "toString"
	 * 
	...
	/**
	 * Check the input string for variables, expressions that are surrounded by
	 * "${" and "}". Remove package prefix if any. For example : "${Message =
	 * ${no.systek.jfsm.action.ReceiveSmsMsg.getMessage}, MSISDN =
	 * ${no.systek.jfsm
	 * .action.ReceiveSmsMsg.getMsisdn}" should return : "${Message =
	 * ${ReceiveSmsMsg.getMessage}, MSISDN = ${ReceiveSmsMsg.getMsisdn}"
	 * 
	 * @param input The input string
	...
	/**
	 * Check the input string for variables, expression that are surrounded by
	 * "${" and "}". Return the enclosed string of the first occurrence, or null
	 * if not found.
	 * 
	 * @param input The input string
	 * @return The variable string, or null if none were found
